...
function weapons.Gun:new(o) --R we should js replace this with "Gun" we can add an o.GunType in this or smth
    o = o or {}
    setmetatable(o, self)
    self.__index = self
    ...
    o.ammo = o.ammo or 30
    o.type = o.type or "heavy_gun"
    o.floor_sprite = o.floor_sprite or love.graphics.newImage(consts.WEAPON_PATH .. "range/" .. o.type .. "_floor.png")
    o.hold_sprite = o.hold_sprite or love.graphics.newImage(consts.WEAPON_PATH .. "range/" .. o.type .. "_hold.png")
    o.sprite = o.floor_sprite

    return o
end

function weapons.Gun:update(dt, mouse_selection_box, player)
    self.player = player
...
function weapons.Gun:mousepressed(button)
...
function weapons.Gun:keypressed(key)
